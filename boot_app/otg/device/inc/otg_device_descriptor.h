...
/* AUDIO_CDC: Speaker + CDC ACM with IADs (Windows needs IAD + EF/02/01).
 * wTotalLength = 9 + 8(Audio IAD) + 49(AC) + 55(AS) + 8(CDC IAD) + 35 + 23 = 187 = 0xBB */
const uint8_t ConfigDescriptor_Tab(AUDIO_CDC)[] =
{
	0x09, 0x02, 0xBB, 0x00, 0x04, 0x01, 0x00, 0x80, 0x32,

	/* IAD: Audio function IF0-IF1 */
