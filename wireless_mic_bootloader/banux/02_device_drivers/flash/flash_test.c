/**
 * flash_test.c - 鏂�Flash 椋卞姩鏋舵瀯娴嬭瘯浠ｇ�? * 娴嬭�?flash_bus + flash_devices + flash_nor_w25qxx 鏋舵�? */
...
/**
 * @brief 娴嬭瘯鍗曚釜 Flash 璁惧�? * @param dev 璁惧鎸囬拡
 * @param device_name 璁惧鍚嶇О锛堢敤浜庢墦鍗帮級
 * @return true 娴嬭瘯閫氳繃锛宖alse 娴嬭瘯澶辫触
 */
static bool test_single_flash_device(FlashDevice_t *dev, const char* device_name)
{
    FlashDevInfo_t info;
    uint32_t test_address = 0x1000; /* 浣跨敤绗簩涓�K鎵囧�?*/
    uint16_t i;
    bool result = true;
...
/**
 * @brief NOR Flash �������� (���� BANBOX_II ��片 NOR �;ɰ�˫片 NOR)
 */
